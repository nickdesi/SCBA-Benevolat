...
## 2026-04-17 - [Caching External API Requests]
When performing multiple parallel requests to enrich entities with external data (e.g. locations from Nominatim and Data ES), using a simple JavaScript promise cache keyed by the entity identifier significantly reduces network requests, saves latency, and prevents potential rate-limiting.
