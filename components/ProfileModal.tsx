...
const ProfileModal: React.FC<ProfileModalProps> = ({
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-0 sm:p-4">
            ...
            <div className="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-5xl bg-slate-50 dark:bg-slate-900 sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-scale-in">
                <VolunteerDashboard
                    user={user}
