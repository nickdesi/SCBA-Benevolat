...
const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    version: 'v2.6.3',
    date: '30 Avril 2026',
    changes: ['🏷️ Build : Remplacement du label dev par le hash Git réel quand il est disponible'],
  },
  {
    version: 'v2.6.2',
    date: '30 Avril 2026',
  ...
  },
  {
    ...
    date: '15 Février 2026',
    changes: [
      '✨ UI : Compteur de matchs (Total/Dom/Ext) sur le calendrier',
      '📱 UX : Amélioration lisibilité header planning',
    ],
  },
  {
    version: 'v2.3.4',
  ...
  },
  {
    version: 'v2.3.1',
    date: '01/02/2026',
    changes: ['🐛 Fix : Affichage Timeline (Animation)', '🚀 Perf : Bundle optimisé (-27%)'],
  },
  {
    version: 'v2.3.0',
    date: '01/02/2026',
  ...
  },
  {
    version: 'v2.2.1',
    date: '27/01/2026',
    changes: ['🔧 Maintenance : Conformité LTS (Node 24 Types)'],
  },
  {
    version: 'v2.2.0',
    date: '27/01/2026',
  ...
  },
  {
    ...
    date: '18/01/2026',
    changes: [
      '🚀 Major Update : UI/UX Pro Max',
      "📢 Broadcast : Système d'annonces",
      '🙋‍♂️ Dashboard : Espace bénévole modernisé',
    ],
  },
  {
    version: 'v1.11.0',
    date: '17/01/2026',
    changes: [
      '✨ UI : Restauration du design "Pilule" centré',
      '📱 UX : Bouton "Aujourd\'hui" large et accessible',
      '💎 Design : Effets de flou et ombres optimisés',
    ],
  },
  {
    version: 'v1.10.5',
    date: '17/01/2026',
    changes: [
      '📱 Mobile UX : Flèches de navigation agrandies',
      '📝 Lisibilité : Bouton "Aujourd\'hui" toujours visible',
    ],
  },
  {
    version: 'v1.10.4',
    date: '17/01/2026',
    changes: ['📉 UI : Navigation compacte (Gain espace vertical)', '✨ Design minimaliste'],
  },
  {
    version: 'v1.10.3',
    date: '17/01/2026',
    changes: [
      '🚗 Covoiturage Intelligent : Badges de statut (Urgence/Dispo)',
      '👀 Visibilité immédiate des demandes',
    ],
  },
  {
    version: 'v1.10.2',
    date: '17/01/2026',
    changes: [
      '🚀 Perf : Optimisation chargement polices (-50% poids)',
      '📱 Meilleure réactivité réseau',
    ],
  },
  {
    version: 'v1.10.1',
    date: '17/01/2026',
    changes: [
      '✨ Badge COMPLET flashy',
      '🎨 Overlay bordures robuste',
      '🌔 Filigranes visibles Dark Mode',
    ],
  },
  {
    version: 'v1.10.0',
    date: '17/01/2026',
    changes: ['🎨 Dark mode amélioré', '🏠 Filigranes maison/avion', '🔲 Badge matchs centré'],
  },
  {
    version: 'v1.9.9',
    date: '17/01/2026',
    changes: ['⚡ React 18 startTransition : changement de vue non-bloquant'],
  },
  {
    version: 'v1.9.8',
    date: '17/01/2026',
    changes: ['⚡ Interface snappy : animations réduites, transitions instantanées'],
  },
  {
    version: 'v1.9.7',
    date: '17/01/2026',
    changes: [
      ...
      '🔘 Bouton Liste/Semaine clair',
      '🕒 Matchs passés masqués',
    ],
  },
  {
    version: 'v1.9.6',
    date: '16/01/2026',
    changes: ['✨ Badge "Complet" célébration : gradient vert, animation shine'],
  },
  {
    version: 'v1.9.5',
    date: '16/01/2026',
    changes: ['📊 Dashboard Admin : Section urgences, filtres, détail des rôles manquants'],
  },
  {
    version: 'v1.9.4',
    date: '09/01/2026',
    changes: ['🧮 Amélioration : Compteur bénévoles "utile" (Postes pourvus)'],
  },
  { version: 'v1.9.3', date: '09/01/2026', changes: ['🔍 SEO : Google Analytics & Sitemap'] },
  {
    version: 'v1.9.2',
    date: '09/01/2026',
    changes: ['📅 Correctif : Affichage date calendrier mobile'],
  },
  {
    version: 'v1.9.1',
    date: '09/01/2026',
    changes: ['🦟 Correctif : Fond blanc en mode sombre fixé'],
  },
  {
    version: 'v1.9.0',
    date: '09/01/2026',
    changes: [
      '🎨 UI/UX Premium (Refonte GameCard)',
      '🖱️ Drag-to-Scroll Desktop',
      '🏎️ Tri Intelligent & Indicateur Urgence',
    ],
  },
  {
    version: 'v1.8.0',
    date: '08/01/2026',
    changes: [
      '📅 Vue Planning interactive complète (Inscriptions, Covoiturage, Calendrier)',
      '🚗 Badge covoiturage détaillé (Conducteurs/Passagers)',
      '🗑️ Icônes de suppression uniformisées',
      '✨ Correctifs de notifications en doublon',
    ],
  },
  {
    version: 'v1.7.0',
    date: '08/01/2026',
    changes: [
      '🎨 Refonte visuelle de la vue Planning (Dark Mode premium)',
      "📍 Intégration liens Waze pour les matchs à l'extérieur",
      '⏱️ Affichage des horaires et lieux complets dans le calendrier',
    ],
  },
  {
    version: 'v1.6.0',
    date: '01/01/2025',
    changes: [
      '🚗 Gestion complète du covoiturage dans "Mon Espace Bénévole"',
      '💡 Affichage des opportunités de covoiturage',
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span title={new Date(__APP_BUILD_DATE__).toLocaleString('fr-FR')}>
                {BUILD_LABEL}
              </span>
              <svg
