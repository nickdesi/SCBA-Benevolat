        ...
        <AnimatePresence mode="popLayout">
          {filtered.length === 0 ? (
            ...
            >
              ...
              <p className="font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest text-xs">
                Champ libre
              </p>
              <p className="text-sm text-slate-400 dark:text-slate-600 mt-2 font-medium">
            ...
            <div className="space-y-3">
              {filtered.map((reg) => (
                <motion.div
                  ...
                  className="group flex items-center gap-4 p-4 rounded-2xl bg-white/50 dark:bg-slate-800/30 hover:bg-white dark:hover:bg-slate-800 transition-all duration-300 border border-slate-200 hover:border-indigo-100 dark:border-white/5 dark:hover:border-white/10 hover:shadow-xl relative overflow-hidden"
                >
                  ...
                  <div className="flex-grow min-w-0 relative z-10">
                    <h4 className="font-black text-slate-800 dark:text-slate-100 text-sm tracking-tight mb-2 leading-snug break-words">
                      {reg.team}{' '}
                      <span className="text-indigo-500 font-bold opacity-50 mx-1">vs</span>{' '}
                      {reg.opponent}
                    </h4>
