...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className={className}>
    ...
    <path
      fill="#FF3D00"
      d="M6.3 14.7l6.6 4.8C14.6 15.1 18.9 12 24 12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.1 6.1 29.3 4 24 4 16.3 4 9.6 8.3 6.3 14.7z"
    />
    <path
      fill="#4CAF50"
      d="M24 44c5.1 0 9.8-1.9 13.3-5.1l-6.2-5.2C29.1 35.2 26.7 36 24 36c-5.2 0-9.6-3.3-11.3-7.8l-6.6 5.1C9.4 39.6 16.1 44 24 44z"
    />
    <path
      fill="#1976D2"
...
export const GoogleCalendarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className={className}>
    ...
    <path
      fill="#4285F4"
      d="M37,6H11c-2.76,0-5,2.24-5,5v26c0,0.55,0.45,1,1,1h4V11c0-2.76,2.24-5,5-5h21V6z"
    />

    {/* Green Segment (Bottom-Left / Bottom) */}
    <path
      fill="#34A853"
      d="M11,42h26c0.55,0,1-0.45,1-1v-4H16c-2.76,0-5-2.24-5-5V12H6v25C6,39.76,8.24,42,11,42z"
    />
    ...
    <g transform="translate(14, 15)">
      <path
        fill="#4285F4"
        d="M3.5,0h4.8v2.4H6.3v1.5h2v2.4h-2V7.8h2.1v2.4H3.5V8.9H4V7.5H3.5V0z M12,0h2.4v10.2H12V3h-1.6L9.6,4.2L8.9,2.8L11.8,0.9H12z"
        transform="scale(1.5)"
      />
    </g>
  </svg>
...
export const OutlookCalendarIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className={className}>
    ...
    <path
      fill="#fff"
      d="M22 17h16v-2h-16v2zm0 4h16v-2h-16v2zm0 4h16v-2h-16v2zm0 4h10v-2h-10v2z"
      opacity="0.8"
    />
    ...
    <path
      fill="#0072C6"
      d="M2 11S1 11 1 12v24c0 1 1 2 2 2h14l.01-14.73 24.99-9.13V12c0-1-1-2-2-2H2zm26.06 9.87L15.01 26.68 2 20.87v-5l26.06 5z"
    />
    ...
    <path
      fill="#0078D4"
      d="M26 12L2 20.87v2.32L26 14.32V12zm0 18.84l-11-4.89V12l11 4.91v13.93z"
      opacity="0"
    />
