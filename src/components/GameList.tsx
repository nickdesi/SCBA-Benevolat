      ...
      <div className="space-y-8">
        {groups.map((group, groupIdx) => (
          <section key={`${group.label}-${groupIdx}`} className="relative">
            ...
            <div className="sticky top-[130px] sm:top-[142px] z-20 my-4">
              <div className="flex items-center justify-between gap-3 px-4 py-2.5 rounded-2xl bg-white/98 dark:bg-slate-900/98 border border-slate-200/90 dark:border-slate-800/90 shadow-sm">
            ...
            {/* Grille responsive fluide et instantanée : aucun calcul de fragmentation de colonne */}
