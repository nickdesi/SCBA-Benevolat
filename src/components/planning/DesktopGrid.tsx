                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-2">
                      <div
                        className={`text-sm font-bold px-3 py-1 rounded-lg ${isToday ? 'bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-300' : 'bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300'}`}
                      >
