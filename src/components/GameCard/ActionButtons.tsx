      ...
      {showCalendarPicker && (
        ...
        >
          <button
            ...
            className="w-full px-4 py-3 flex gap-3 hover:bg-slate-50 text-sm font-medium text-slate-700 items-center"
          >
          ...
          <button
            ...
            className="w-full px-4 py-3 flex gap-3 hover:bg-slate-50 text-sm font-medium text-slate-700 border-t border-slate-50 items-center"
          >
