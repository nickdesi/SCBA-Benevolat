...
export const GYM_REGISTRY: Record<string, string> = {
  ...
  'CTC BÉDAT VOLCANS BASKET - NOHANENT PUY VALEIX':
    'Espace Sportif du Puy Valeix, Rue du Puy-Valeix, 63830 Nohanent',
  ...
  'CTC OUEST MONTPELLIER METROPOLE BASKET':
    'Gymnase Miralles, Rue Federico Garcia Lorca, 34430 Saint-Jean-de-Védas',
  'IE - CTC OUEST MONTPELLIER METROPOLE BASKET - 1':
    'Gymnase Miralles, Rue Federico Garcia Lorca, 34430 Saint-Jean-de-Védas',
  ...
  'IE - CASTELNAU BASKET':
    'Palais des Sports J. Chaban-Delmas, 515 avenue de la Monnaie, 34170 Castelnau-le-Lez',
  ...
  'ANDREZIEUX-BOUTHEON LOIRE SUD BASKET - 2':
    'Palais des Sports, 23 rue des Bullieux, 42160 Andrézieux-Bouthéon',
  'LES ENFANTS DU FOREZ FEURS ROZIER - 2':
    'Forezium André Delorme, Rue de la Paparelle, 42110 Feurs',

  // Nouveaux ajouts (U18M1 - Région A)
  PONTOISE: 'Gymnase Bonbonnière, Rue des Écoles, 42170 Saint-Just-Saint-Rambert',
  'PONTOISE ULR BASKET ST JUST ST RAMBERT':
    'Gymnase Bonbonnière, Rue des Écoles, 42170 Saint-Just-Saint-Rambert',
  ...
  "JEANNE D'ARC DE VICHY":
    "Palais des Sports Pierre Coulon, Route du Pont de l'Europe, 03700 Bellerive-sur-Allier",

  // Nouveaux ajouts (U18M2 - Région B)
  'ETOILE DE CHAMALIERES SAYAT':
    'Complexe Sportif Alain Bresson, 2 Bis Allée du Gymnase, 63400 Chamalières',
  ...
  'US VIC LE COMTE BASKET':
    "Complexe Sportif Omnisport André Boste, Route d'Ambert, 63270 Vic-le-Comte",
  'VIC LE COMTE': "Complexe Sportif Omnisport André Boste, Route d'Ambert, 63270 Vic-le-Comte",
  'IE - CTC CLERMONT SUD GERGOVIE BASKET - BASKET CLUB LA ROCHE BLANCHE - 2':
    'Salle des Sports, Rue du Stade, 63670 La Roche-Blanche',
