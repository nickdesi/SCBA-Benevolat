 ...
 */
export const StyledRoleIcon: React.FC<{ role: string; size?: 'sm' | 'md' | 'lg' }> = ({
  role,
  size = 'md',
}) => {
  ...
  return (
    <div
      className={`${containerSize[size]} rounded-xl ${config.bgColor} flex items-center justify-center flex-shrink-0`}
    >
